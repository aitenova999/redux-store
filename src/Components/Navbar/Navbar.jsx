    ...
    <>
      ...
      <div className="flex justify-around items-center">
        ...
        <div className="flex flex-row items-center">
          <button
            className=" font-inter text-bas font-medium tracking-normal leading-none text-center mr-4
          "
          >
            Logout
          </button>
          <div className="flex flex-row items-center">
            ...
            <p className="font-inter text-bas font-medium tracking-normal leading-none text-center mr-2">
              Wish List
            </p>
          </div>
          <div
          ...
          >
            ...
            <p className="font-inter text-bas font-medium tracking-normal leading-none text-center ">
              Shopping bag
            </p>
